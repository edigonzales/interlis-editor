...
export function renderResources(): React.ReactNode {
    return <section className='interlis-editor-section'>
        <h3>Resources</h3>
        <ul>
            <li><ExternalLink href='https://github.com/edigonzales/interlis-lsp'>INTERLIS language tooling</ExternalLink></li>
...
export function renderAboutText(): React.ReactNode {
    return <>
        <p>
            ...
            maintained INTERLIS VS Code extension.
        </p>
        <p>
